    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-yuzu-50 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="max-w-md text-center">
          <div className="w-16 h-16 rounded-full bg-yuzu-100 flex items-center justify-center mx-auto mb-6">
            <PartyPopper className="w-9 h-9 text-yuzu-600" />
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 mb-8 text-left">
              ...
              {[
                ...
                <li key={text} className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-yuzu-50 flex items-center justify-center shrink-0">
                    <Icon className="w-4 h-4 text-yuzu-600" />
                  </div>
          ...
          <button className="w-full bg-yuzu-400 hover:bg-yuzu-500 text-white font-semibold py-3 rounded-xl transition-colors">
            Open yuzu App
          </button>
        </div>
      </main>
